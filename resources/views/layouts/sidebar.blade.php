<aside id="sidebar"
    class="fixed w-64 h-screen overflow-y-auto bg-white py-2 px-5 space-y-4 transition-transform duration-300 translate-x-0 z-20">
    ...
    <div class="logo flex items-center gap-2 h-12">
        ...
        <a href="#" class="font-montserrat text-lg font-bold text-gray-800">fixIT!</a>
    </div>

    <ul class="space-y-2 mt-4 text-gray-700 font-medium">
        <li>
            <button id="toggleSubmenu"
                class="flex justify-between items-center w-full px-3 py-2 rounded hover:bg-gray-200 transition">
                <span class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#000000">
                        <path
                            d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z" />
                    </svg> Dashboard</span>
                <svg id="arrowIcon" class="w-4 h-4 transition-transform" xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
            <ul id="submenu" class="mt-2 ml-6 space-y-1 hidden">
                <li><a href="#" class="flex items-center px-3 py-2 rounded hover:bg-green-600">○ Dashboard v1</a>
                </li>
                <li><a href="#" class="flex items-center px-3 py-2 rounded hover:bg-green-600">○ Dashboard v2</a>
                </li>
                <li><a href="#" class="flex items-center px-3 py-2 rounded hover:bg-green-600">○ Dashboard v3</a>
                </li>
            </ul>
        </li>
